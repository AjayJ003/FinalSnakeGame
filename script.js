...
let foodX,foodY,foodX1,foodY1,foodX2,foodY2;
let foodlist=[[foodX,foodY],[foodY1,foodX2],[foodX2,foodY2]];
let element=[1,2,3];
let cont=0;
let gameOver=false;
let snakebody=[
...
const createfood = () => {
    ...
    foodlist=[[foodX,foodY],[foodX1,foodY1],[foodX2,foodY2]];
...
setIntervalEle=setInterval(startGame,100);
